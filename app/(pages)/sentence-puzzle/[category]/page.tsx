...
export default function LessonsPage() {
    ...
    return (
        <div className="max-w-5xl mx-auto px-4 py-6 min-h-screen flex items-center justify-center flex-col">
            ...
            {course.lessons.filter(d => d.isVisible).length === 0 &&
                <h1 className="text-3xl font-bold uppercase">darslari mavjud emas</h1>
            }
        </div>
    );
}
