    ...
    useEffect(() => {
        ...
        result = [...result].sort((a, b) => {
            if (sortBy === "title") {
                ...
                return b.lessons.filter(l => l.isVisible).length - a.lessons.filter(l => l.isVisible).length;
        ...
        <div className="min-h-screen bg-gray-900 py-8 px-4 md:px-8 relative">
            ...
            <div className="max-w-7xl mx-auto mb-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-white">Kurslar Lug&apos;ati</h1>
                        <p className="text-gray-400 mt-2">Barcha mavjud kurslarni boshqaring</p>
                    </div>
                ...
                <div className="bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-700">
                    ...
                    {filteredCourses.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-lg font-medium text-gray-300 mb-2">Kurslar topilmadi</h3>
                            <p className="text-gray-500">
                                {searchQuery ? "Qidiruv bo&apos;yicha hech narsa topilmadi" : "Hali kurslar qo&apos;shilmagan"}
                            </p>
                        </div>
                    ) : (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="absolute top-3 right-3 bg-gray-900/80 backdrop-blur-sm rounded-lg px-2 py-1 text-xs font-medium text-purple-300 shadow-sm">
                                            {c.lessons.filter(d => d.isVisible === true).length} dars
                                        </div>
                ...
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md border border-gray-700">
                        <div className="flex items-center justify-between p-6 border-b border-gray-700">
                            <h2 className="text-xl font-bold text-white">Kursni tahrirlash</h2>
                            <button
